...
// jsp012_delete.jsp
	...
	String oname = request.getParameter("oname2");
	int		onum = Integer.parseInt(request.getParameter("onum2"));
	...
	try {
		...
		if(result > 0) { 
			out.println("<script> alert('우유주문 성공했습니다.');	location.href='milks.jsp';	</script>");
		} else {
			out.println("<script> alert('우유주문 실패 (관리자 문의)');	location.href='milks.jsp';	</script>");
		}
