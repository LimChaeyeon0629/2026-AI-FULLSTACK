# 📚 2026-AI-FULLSTACK Bootcamp

> **Java 웹 개발부터 Python·Django까지,
> 6개월간의 학습 과정과 실습 코드를 기록하는 저장소입니다.**

이 저장소는 부트캠프에서 학습한 내용을
기술과 과정별로 정리한 개인 학습 기록입니다.

수업에서 익힌 개념을 예제와 실습 코드로 직접 확인하고,
다시 참고할 수 있도록 학습 내용을 꾸준히 정리하고 있습니다.
...
<img style="width:120px" alt="임채연" src="https://github.com/user-attachments/assets/2adf117f-a8ac-489e-b0f8-b36112c4481f" />
...
* 프론트엔드·백엔드·데이터베이스의 기본 흐름 이해
* 새로운 기술을 직접 실행하고 응용하는 연습
...
* Java 객체지향 문법을 활용해 프로그램을 구성하는 방법
* SQL을 작성하고 애플리케이션과 데이터베이스를 연결하는 과정
* MVC 패턴을 기반으로 화면과 서버 로직의 역할을 분리하는 방법
* Spring Boot를 활용한 REST API와 웹 애플리케이션의 기본 구조
* React와 Next.js를 활용해 데이터를 화면에 표현하는 방법
* Linux와 AWS 환경에서 애플리케이션을 실행하는 기본 과정
* Python과 Django를 활용한 데이터 처리 및 웹 개발 기초
