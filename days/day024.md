...
Cat 멤버함수 @eat(), @sleep(), @poo()
Dog 멤버함수 @eat(), @sleep(), @poo()
...
public class Abstract001 {
   public static void main(String[] args) {
      ...
      Animal ani = new Animal();   Q3. 이코드에서 오류나는 이유는? - { } 구현부 없어서
...
class Son extends Papa, Mama{ } // implements 사용하지 않고 extends로 상속 2개
...
interface Animal2{
   String company="(주) thejoa";    //Q7.  interface에서의 멤버변수에 붙는 키워드는? - kakao
