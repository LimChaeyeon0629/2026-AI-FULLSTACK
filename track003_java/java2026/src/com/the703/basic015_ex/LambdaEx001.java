...
public class LambdaEx001 {
    public static void main(String[] args) {
    	...
    	// 람다식
    	Printer p11 = msg -> { System.out.println("Message: " + msg); };
    	p1.print("Hello World");

    	Printer p22 = msg -> { System.out.println("Message: " + msg); };
    	p2.print("Lambda Rocks!");
    	...
    	System.out.println("익명객체 결과: " + c2.add(10, 20));

    	// 람다식
    	Calculator c11 = (a, b) -> a+b;
    	System.out.println("람다식 결과: " + c11.add(3, 5));
    	
    	Calculator c22 = (a, b) -> a+b;
    	System.out.println("람다식 결과: " + c22.add(10, 20));
