...
public class Day027 {
	public static void main(String[] args) {
		// List 기차 순서 o
		// 주기:add, 가져오기:get, 갯수:size, 삭제:remove, 포함여부:contains
...
//		}
		for(int i=0; i<users.size(); i++) {		// size 갯수 → 4
			UserInfo u = users.get(i);			// get(번호) 꺼내오기 → 0 1 2 3
			System.out.printf("%d\t%s\t%d\n", (i+1), u.getName(), u.getAge());
		}
		
		// Set 주머니 순서 x
		// 주기:add, 가져오기:향상된 for/Iterator, 갯수:size, 삭제:remove, 포함여부:contains
