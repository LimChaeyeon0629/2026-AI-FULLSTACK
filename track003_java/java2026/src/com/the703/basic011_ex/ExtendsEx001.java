...
/*
		...
		-------------------------------------------
		1. Green = Object(부품객체) Color = Object(부품객체)
...
class Green extends Color { // 부모클래스 Color 상속
	public Green() { super(); } 
	public Green(String name, int num) { super(name, num); }

	public void show() {
		System.out.println("GREEN");
		System.out.println("NAME : " + this.name); 		// 인스턴스 this
		System.out.println("NUM : "  + super.getNum()); // main()에서 num 숫자 받기
	}
}
