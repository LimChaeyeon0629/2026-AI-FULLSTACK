 ...
 */
class Product extends Object { // 상속을 받을게, Object ( 클래스의 기본 틀 ), Object 생략 가능
	// 인스턴스 변수
	String name; 	// null
	int price;		// 0
	
	// 멤버 함수
	public Product() { super(); } // 여기서 super는 부모 Object
	public Product(String name, int price) { super(); this.name = name; this.price = price; }
	// 각각의 내꺼 (1번지의 name, price) (2번지의 name, price)
...
public class Class004 {
	public static void main(String[] args) {
		Product p1 = new Product("아이폰17", 100);	 // 1) new 객체생성 	2) 생성자-초기화	3) p1 주소갖기
		System.out.println(p1);		 // p1(1번지) → 1번지: Product [name=null, price=0]
		
		Product p2 = new Product();	 // 1) new 객체생성 	2) 생성자-초기화	3) p2 주소갖기
...
/* [RUNTIME DATA AREA]
------------------------------------
[METHOD:정보] Product.class Class004.class #1
------------------------------------
[HEAP:동적]        			   	 		|  [STACK:지역]
