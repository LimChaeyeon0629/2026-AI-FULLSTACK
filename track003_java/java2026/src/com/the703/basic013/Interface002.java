...
public class Interface002 {
	public static void main(String[] args) {
		...
		if(myson2 instanceof Object) {
			System.out.println("1. Object");
		} 
		
		if(myson2 instanceof Papa2) {
			System.out.println("2. Papa2");
		}
		
		if(myson2 instanceof Inter11) { // implements
			System.out.println("3. Inter11");
		} 
		
		if(myson2 instanceof Inter12) { // implements
			System.out.println("4. Inter12");
		}
	}
}
