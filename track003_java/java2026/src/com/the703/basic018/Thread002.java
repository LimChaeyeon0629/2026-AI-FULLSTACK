...
public class Thread002 { 				// Ctrl + Shift + F
	public static void main(String[] args) {
		Thread sound = new PigSound();	// 부모 = 자식 상속
		Thread count = new PigCount();
		Thread beep  = new PigTest();
		sound.start(); 					// #3. start 사용
		count.start();
		beep.start();
