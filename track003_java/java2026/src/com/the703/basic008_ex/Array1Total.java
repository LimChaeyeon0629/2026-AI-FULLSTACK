...
public class Array1Total {
	...
	public static void main(String[] args) {
		    ...
		    int [] aver = new int[5];
		    String [] pnp = new String[5];
		    String [] j = new String[5];

		    int data = 0;
		    
		    System.out.println(":::::::::::::::::::::::::::::::::::::::::::::::::::::::");
		    System.out.println("이름\t국어\t영어\t수힉\t평균\t합격여부\t장학생");
		    System.out.println(":::::::::::::::::::::::::::::::::::::::::::::::::::::::");
		    
		    // 처리 + 출력
		    for(int i = 0; i < aver.length; i++) {
		    	aver[i] = (kor[i] + eng[i] + mat[i]) / 3;
		    	pnp[i] = aver[i] < 60 ? "불합격" : "합격";
		    	j[i] = aver[i] >= 95 ? "장학생" : "";
		    	
		    	arr[i] = data;
		    	data += 1;
		    	System.out.printf("%s\t%d\t%d\t%d\t%d\t%s\t%s\n", name[i], kor[i], eng[i], mat[i], aver[i], pnp[i], j[i]);
		    }
		    System.out.println(":::::::::::::::::::::::::::::::::::::::::::::::::::::::");
		    
		    
//		    	System.out.println(aver[i]); // 평균
//		    	System.out.println(pnp[i]); // 패논패
//		    	System.out.println(j[i]); // 장학생
