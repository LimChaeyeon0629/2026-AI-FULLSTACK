...
//		500개의 별빛이 밤하늘을 수놓는다.
		...
		// 4. 변수의 범위
		{ // 여기서부터
			int b = 990; System.out.println("특별할인! " + b + "에 모셔요~!");
		} // 여기까지
		// System.out.println("특별할인! " + b + "에 모셔요~!");
		
		// 5. 변수명 $ _ 소문자
		int $1 = 1;		int _2 = 2; 	int a3bc = 3;	 int HOME = 3;
		// int int; 	int void; // 색깔 들어가 있는 예약어 사용불가
		int main;
