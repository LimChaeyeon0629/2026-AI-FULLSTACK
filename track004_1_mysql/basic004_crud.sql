...
-- 10:36:03	insert into userinfo values ('aaa', 11, 2) Error Code: 1366.
-- Incorrect integer value: 'aaa' for column 'no' at row 1	0.000 sec

insert into userinfo values (1, 'bbb', 22);
-- 10:37:11	insert into userinfo values (1, 'bbb', 22) Error Code: 1062.
...
insert into userinfo (name, age) values (22, 'bbb'); -- x (자료형이 맞지 않음)
-- 10:41:58	insert into userinfo (name, age) values (22, 'bbb')	Error Code: 1366.
...
-- mysql>
-- insert into emp (empno, ename, job, mgr, hiredate, sal, comm, dept) values (7369, SMITH, CLERK, 7902, 1980-12-17, 800, NULL, 20);
desc emp;
...
SET SQL_SAFE_UPDATES=0;		-- SAFE 안 쓸래!
delete   from userinfo;
-- 11:43:25	delete   from userinfo	Error Code: 1175.
...
update userinfo set age=10, name='fff'		where no=1;						-- age, name 변경
update userinfo set age=22	 				where no=2 and name='second';	-- age 변경
update userinfo set name='first', age=11	where no=1;						-- name, age 변경
update userinfo set age=10, name='three'	where no=3;						-- age, name 변경
...
--   조건에 안 맞으면 업데이트 불가. name 'first' 생략
...
-- update score set semail='admin@gmail.com'				where sno='1';
-- update score set semail='admin@gmail.com'				where sno='2';
-- update score set semail='admin@gmail.com'				where sno='3';
-- update score set semail='admin@gmail.com'				where sno='4';
-- update score set semail='admin@gmail.com'				where sno='5'; 
update score set semail='admin@gmail.com';
select * from score;


-- [003]  성적의 총합(sstotal)을 계산해서 넣기   sjava+sjsp+sspring+sproject
-- update score set sstotal = sjava+sjsp+sspring+sproject	where sno='1';
-- update score set sstotal = sjava+sjsp+sspring+sproject	where sno='2';
-- update score set sstotal = sjava+sjsp+sspring+sproject	where sno='3';
-- update score set sstotal = sjava+sjsp+sspring+sproject	where sno='4';
-- update score set sstotal = sjava+sjsp+sspring+sproject	where sno='5';
...
desc score; -- score type int
alter table score modify ssavg double;
-- update score set ssavg = sstotal/4.0			where sno='1';
-- update score set ssavg = sstotal/4.0			where sno='2';
-- update score set ssavg = sstotal/4.0			where sno='3';
-- update score set ssavg = sstotal/4.0			where sno='4';
-- update score set ssavg = sstotal/4.0			where sno='5';
...
-- 조건에 맞는게 없으면,,,,,, 반영안됨.
update score set semail = 'fiest@gmail.com'		where ssavg=100;
select * from score;
 
-- [006]  이름이 bbb인 학생의 sjava 점수를 92 , sjsp점수를 78로 , 총점, 평균을  수정하시오
update score set sjava=92, sjsp=78,
				 sstotal = sjava+sjsp+sspring+sproject, ssavg = sstotal/4.0				where sname='bbb';
select * from score;
...
-- [009]   sproject점수가 80점 미만인 학생의 semail을 blackstdudent@gmail.com으로 수정하시오
...
create table userinfo2 select * from userinfo;	-- 구조 + 데이터
	-- no auto_increment, primary key 추가
alter table userinfo2 modify no int not null auto_increment primary key;
desc userinfo2; -- primary key(PK), auto_increment 빠짐, 기본값은 다시 가져와야함
