...
describe( 'user reducer', ()=> {
    ...
    // 사용 시 : action { type: LOG_IN_SUCCESS, data: fakeUser }
    // REDUCER : 상태업데이트 시 return { ...state, isLoading: false, error: action.data };
    ...
    it('UPDATE_NICKNAME_SUCCESS', ()=> {
        ...
        //         : state.me
        //         users: state.user.map( (u)=> u.id === action.data.id
        //         ? { ...u, nickname: adction.data.nickname }
        //         : u
        // };
