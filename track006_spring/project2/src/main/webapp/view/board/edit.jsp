...
<div class="container  my-5">
	<h3>글 수정</h3>
	<form
		action="${pageContext.request.contextPath}/board/edit.do?bno=${dto.bno}"
		...
		<div class="my-3">
			<label for="bname" class="form-label">이름</label> <input type="text"
				class="form-control" id="bname" name="bname" value="${dto.bname}"
				readonly />
		</div>
		<div class="my-3">
		...
		<div class="my-3">
			<label for="btitle" class="form-label">제목</label> <input type="text"
				class="form-control" value="${dto.btitle}" id="btitle" name="btitle" />
		</div>
		<div class="my-3">
		...
		<div class="my-3">
			<label for="bfile" class="form-label">기존파일</label> <input type="text"
				id="bfile" name="bfile" value="${dto.bfile}" readonly
				class="form-control" />
		</div>
		<div class="my-3">
			<label for="file" class="form-label">파일업로드</label> <input type="file"
